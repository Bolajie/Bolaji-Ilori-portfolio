        ...
        <div className={`relative overflow-hidden rounded-2xl border transition-all duration-700 ${isValidated ? 'bg-brand-surface border-emerald-500/20 shadow-[0_0_60px_rgba(16,185,129,0.08)]' : 'bg-brand-surface border-white/[0.06]'}`}>
          ...
          <div className="p-8 sm:p-14 flex flex-col items-center text-center">
            ...
            <button
              ...
              className="group flex items-center gap-5 mb-14 focus:outline-none"
            >
            ...
            {FEATURED_PROJECTS.map((project, i) => (
              <div key={project.id} className="group relative bg-brand-surface border border-white/[0.06] rounded-2xl p-7 sm:p-8 hover:border-brand-orange/25 transition-all duration-500 overflow-hidden flex flex-col">
                ...
                <button
                  ...
                  className="w-full py-2.5 border border-white/[0.08] text-brand-muted rounded-xl hover:border-brand-orange/30 hover:text-brand-cream transition-all flex items-center justify-center gap-2 font-display font-bold text-xs uppercase tracking-widest"
                >
                  Technical Breakdown
      ...
      {selectedProject && (
        <div className="fixed inset-0 z-[100] flex items-end sm:items-center justify-center p-0 sm:p-6">
          ...
          <div className="bg-brand-surface border border-white/[0.08] w-full sm:max-w-xl rounded-t-3xl sm:rounded-2xl p-8 sm:p-10 relative z-10 shadow-2xl animate-reveal">
            <button onClick={() => setSelectedProject(null)} className="absolute top-5 right-5 p-2 text-brand-muted hover:text-brand-cream transition-colors">
            ...
            <div className="flex justify-end">
              <button onClick={() => setSelectedProject(null)} className="px-6 py-2.5 bg-brand-cream text-brand-deep font-display font-bold text-xs uppercase tracking-widest rounded-xl hover:bg-white transition-colors">
                Close
              </button>
            </div>
          </div>
