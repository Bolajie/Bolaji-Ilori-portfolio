                ...
                {isValidated ? (
                  ...
                  <div className="w-full h-full relative">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-3 gap-4 h-full overflow-hidden opacity-60">
                      {[...Array(9)].map((_, i) => (
                        <div key={i} className="bg-red-500/5 border border-red-500/10 p-3 rounded-lg flex flex-col justify-center items-start animate-pulse" style={{ animationDelay: `${i * 0.11}s` }}>
